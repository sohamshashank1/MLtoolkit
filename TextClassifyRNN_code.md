...
```
### We could also use some other document and create a document term matrix. That would be considered as X_train and X_test. 
### And a separate column of a dataframe can be taken as Y_train and Y_test and train the RNN model 
